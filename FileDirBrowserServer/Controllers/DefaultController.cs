...
namespace FileDirBrowserServer.Controllers
{
    ...
    {
        private int[] sizeFile = new int[3];
        ...
        public ExplorerModel Index(string realpath = "")
        {
            ...
            if (string.IsNullOrEmpty(realpath))
            {
                ...
                List<DirModel> drivesListModel = drivesList.Select(
                    
                    drive => new DirModel {DirName = drive})
                                                    .ToList();
            ...
            else
            {
                ...
                List<DirModel> dirListModel = (from dir in dirList let d = new DirectoryInfo(dir)
                                               select new DirModel { DirName = Path.GetFileName(dir) })
                                                                                               .ToList();
